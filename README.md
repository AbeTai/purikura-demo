...
- カメラ撮影ではブラウザ側 FaceLandmarker で検出済みフレームだけを顔中心 `960 x 1200` に切り出し、検出済みランドマークも送信
